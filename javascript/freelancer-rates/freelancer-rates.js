...
export function priceWithMonthlyDiscount(ratePerHour, numDays, discount) {
    ...
    const monthlyRate = (dayRate(ratePerHour) * BILLABLE_DAYS_PER_MONTH) - (dayRate(ratePerHour) * BILLABLE_DAYS_PER_MONTH * discount);
    return Math.ceil((monthlyRate * months) + (dayRate(ratePerHour) * remainingDays));
}
